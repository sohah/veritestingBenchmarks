public class WBS {
	...
	public void update(int PedalPos, boolean AutoBrake, boolean Skid) {
	   ...
	   else if(!(WBS_Node_WBS_BSCU_Unit_Delay1 == 0)){
	   ...
	   else if (((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 0) && (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 1))) {					   
		   WBS_Node_WBS_BSCU_Switch2 = 0; 
	   }
	   else if (((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 1) && (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 2)))  {
		   WBS_Node_WBS_BSCU_Switch2 = 1; 
	   } 
	   else if (((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 2) && (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 3))) {
		   WBS_Node_WBS_BSCU_Switch2 = 2; 
	   }
	   else if (((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 3) && (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 4)))  {
	   ...
	   else if (WBS_Node_WBS_BSCU_Switch2 == 0) {
		   Nor_Pressure = 0; 
	   }
	   else { 
		   Nor_Pressure = 0;
	   ...
	   else if (WBS_Node_WBS_SelectorValve_Switch1 >= 1) { 
	...
	public static void main(String[] args) {
		mainProcess(0,false,false,0,false,false);
	}
}
