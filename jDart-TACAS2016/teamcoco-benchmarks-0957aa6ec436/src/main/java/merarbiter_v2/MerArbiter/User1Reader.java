...
import merarbiter_v2.edu.vanderbilt.isis.sm.*;

public class User1Reader implements IDataReader {
	private TopLevelUser1.REGION_T.STATE_T state;
	private IDataProvider dataProvider;
	private IDataPrinter dataPrinter;

	public User1Reader(TopLevelUser1.REGION_T.STATE_T state,
