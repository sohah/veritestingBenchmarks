...
public class RJCMain {
	...
	public void DoSimSymbolic(double in1_0, double in1_1, double in1_2, double in2_0, double in2_1, double in2_2) {
		...
		for (int i = 0; i < 2; i++) {
			out1 = new double[1];
			out2 = new double[2];
			this.controller.MainSymbolic(in1_0, in1_1, in1_2, in2_0, in2_1, in2_2, out1, out2);
		}
	}
}
